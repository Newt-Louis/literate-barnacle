...
def up(cursor: sqlite3.Cursor):
    ...
    cursor.execute("INSERT OR IGNORE INTO language_settings (language, selected_version, executable_path) VALUES ('Python', 'python-3.13.3-amd64', 'D:\Python313');")
    cursor.execute("INSERT OR IGNORE INTO language_settings (language, selected_version, executable_path) VALUES ('Java', 'jdk-21', 'D:\jdk-21');")
