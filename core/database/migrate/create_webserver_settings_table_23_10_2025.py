...
def up(cursor: sqlite3.Cursor):
    ...
    # Chèn dữ liệu mẫu
    cursor.execute(
        "INSERT OR IGNORE INTO webserver_settings (server_name, http_port, ssl_port) VALUES ('apache', 8080, 443);")
    cursor.execute(
        "INSERT OR IGNORE INTO webserver_settings (server_name, http_port, ssl_port) VALUES ('nginx', 80, 8443);")
