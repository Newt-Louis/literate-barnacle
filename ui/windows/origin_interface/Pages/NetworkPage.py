...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.network_title_label = QLabel(Form)
        ...
        self.network_save_change_buttonbox = QDialogButtonBox(Form)
        ...
        self.traceroute_checkbox = QCheckBox(Form)
        ...
        self.network_add_new_button = QPushButton(Form)
    ...
    def retranslateUi(self, Form):
        ...
        self.network_title_label.setText(QCoreApplication.translate("Form", u"<html><head/><body><p><span style=\" font-size:14pt; font-weight:700;\">Network</span></p></body></html>", None))
        self.traceroute_checkbox.setText(QCoreApplication.translate("Form", u"Traceroute", None))
        self.ngrok_checkbox.setText(QCoreApplication.translate("Form", u"Ngrok", None))
        self.telnet_checkbox.setText(QCoreApplication.translate("Form", u"Telnet", None))
        self.network_add_new_button.setText(QCoreApplication.translate("Form", u"New Customize", None))
    # retranslateUi
