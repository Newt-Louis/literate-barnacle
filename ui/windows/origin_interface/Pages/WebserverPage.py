...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.webserver_title_label = QLabel(Form)
        ...
        self.webserver_save_change_buttonbox = QDialogButtonBox(Form)
    ...
    def retranslateUi(self, Form):
        ...
        self.webserver_title_label.setText(QCoreApplication.translate("Form", u"<html><head/><body><p><span style=\" font-size:14pt; font-weight:700;\">Webserver</span></p></body></html>", None))
        self.apache_checkbox.setText(QCoreApplication.translate("Form", u"Apache", None))
        self.nginx_checkbox.setText(QCoreApplication.translate("Form", u"Nginx", None))
    # retranslateUi
