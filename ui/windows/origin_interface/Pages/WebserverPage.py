...
class Ui_WebserverPage(object):
    def setupUi(self, WebserverPage):
        ...
        self.webserver_content_layout.addWidget(self.nginx_select_version_combobox, 15, 1, 1, 1)
        ...
        self.webserver_content_layout.addLayout(self.horizontalLayout_3, 13, 2, 1, 1)

        self.nginx_elp_label = QLabel(WebserverPage)
        self.nginx_elp_label.setObjectName(u"nginx_elp_label")

        self.webserver_content_layout.addWidget(self.nginx_elp_label, 20, 1, 1, 1)
        ...
        self.webserver_content_layout.addItem(self.verticalSpacer_3, 14, 1, 1, 1)

        self.nginx_alp_label = QLabel(WebserverPage)
        self.nginx_alp_label.setObjectName(u"nginx_alp_label")

        self.webserver_content_layout.addWidget(self.nginx_alp_label, 19, 1, 1, 1)
        ...
        self.webserver_content_layout.addLayout(self.horizontalLayout_5, 19, 2, 1, 1)
        ...
        self.webserver_content_layout.addWidget(self.nginx_sites_enabled_label, 16, 1, 1, 1)

        self.nginx_checkbox = QCheckBox(WebserverPage)
        self.nginx_checkbox.setObjectName(u"nginx_checkbox")

        self.webserver_content_layout.addWidget(self.nginx_checkbox, 15, 0, 1, 1)
        ...
        self.webserver_content_layout.addItem(self.verticalSpacer_4, 14, 2, 1, 1)
        ...
        self.webserver_content_layout.addLayout(self.horizontalLayout_4, 16, 2, 1, 1)
        ...
        self.webserver_content_layout.addLayout(self.horizontalLayout_6, 20, 2, 1, 1)
        ...
        self.webserver_content_layout.addLayout(self.horizontalLayout_8, 15, 2, 1, 1)

        self.verticalSpacer_2 = QSpacerItem(20, 40, QSizePolicy.Policy.Minimum, QSizePolicy.Policy.Expanding)

        self.webserver_content_layout.addItem(self.verticalSpacer_2, 14, 0, 1, 1)
        ...
        self.webserver_content_layout.addLayout(self.horizontalLayout_2, 12, 2, 1, 1)

        self.nginx_listen_port_label = QLabel(WebserverPage)
        self.nginx_listen_port_label.setObjectName(u"nginx_listen_port_label")

        self.webserver_content_layout.addWidget(self.nginx_listen_port_label, 17, 1, 1, 1)
        ...
        self.webserver_content_layout.addWidget(self.nginx_listen_port_lineEdit, 17, 2, 1, 1)
    ...
    def retranslateUi(self, WebserverPage):
        ...
        self.apache_checkbox.setText(QCoreApplication.translate("WebserverPage", u"Apache Version", None))
        ...
        self.nginx_checkbox.setText(QCoreApplication.translate("WebserverPage", u"Nginx Version", None))
