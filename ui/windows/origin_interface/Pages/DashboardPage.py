...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.dashboard_title_label = QLabel(Form)
        ...
        self.dashboard_service_label = QLabel(Form)
        ...
        self.dashboard_type_label = QLabel(Form)
        ...
        self.dashboard_version_label = QLabel(Form)
        ...
        self.database_type_label = QLabel(Form)
        ...
        self.network_service_label = QLabel(Form)
        ...
        self.tools_type_3_label = QLabel(Form)
        ...
        self.tools_version_2_label = QLabel(Form)
        ...
        self.tools_version_3_label = QLabel(Form)
        ...
        self.language_service_label = QLabel(Form)
        ...
        self.tools_type_1_label = QLabel(Form)
        ...
        self.tools_type_2_label = QLabel(Form)
        ...
        self.startall_button = QPushButton(Form)
        ...
        self.language_version_label = QLabel(Form)
        ...
        self.tools_version_1_label = QLabel(Form)
        ...
        self.tools_service_label = QLabel(Form)
        ...
        self.network_version_label = QLabel(Form)
        ...
        self.database_service_label = QLabel(Form)
        ...
        self.database_version_label = QLabel(Form)
        ...
        self.network_type_label = QLabel(Form)
        ...
        self.webserver_service_label = QLabel(Form)
        ...
        self.webserver_type_label = QLabel(Form)
        ...
        self.webserver_version_label = QLabel(Form)
        ...
        self.language_type_label = QLabel(Form)
    ...
    def retranslateUi(self, Form):
        ...
        self.dashboard_title_label.setText(QCoreApplication.translate("Form", u"<html><head/><body><p><span style=\" font-size:14pt; font-weight:700;\">Dashboard</span></p></body></html>", None))
        self.dashboard_service_label.setText(QCoreApplication.translate("Form", u"<html><head/><body><p align=\"center\"><span style=\" font-size:12pt;\">Service</span></p></body></html>", None))
        self.dashboard_type_label.setText(QCoreApplication.translate("Form", u"<html><head/><body><p align=\"center\"><span style=\" font-size:12pt;\">Type</span></p></body></html>", None))
        self.dashboard_version_label.setText(QCoreApplication.translate("Form", u"<html><head/><body><p align=\"center\"><span style=\" font-size:12pt;\">Version</span></p></body></html>", None))
        self.database_type_label.setText(QCoreApplication.translate("Form", u"TextLabel", None))
        self.network_service_label.setText(QCoreApplication.translate("Form", u"Network", None))
        self.tools_type_3_label.setText(QCoreApplication.translate("Form", u"TextLabel", None))
        self.tools_version_2_label.setText(QCoreApplication.translate("Form", u"TextLabel", None))
        self.tools_version_3_label.setText(QCoreApplication.translate("Form", u"TextLabel", None))
        self.language_service_label.setText(QCoreApplication.translate("Form", u"Language", None))
        self.tools_type_1_label.setText(QCoreApplication.translate("Form", u"TextLabel", None))
        self.tools_type_2_label.setText(QCoreApplication.translate("Form", u"TextLabel", None))
        self.startall_button.setText(QCoreApplication.translate("Form", u"Start All", None))
        self.language_version_label.setText(QCoreApplication.translate("Form", u"TextLabel", None))
        self.tools_version_1_label.setText(QCoreApplication.translate("Form", u"TextLabel", None))
        self.tools_service_label.setText(QCoreApplication.translate("Form", u"Tools", None))
        self.network_version_label.setText(QCoreApplication.translate("Form", u"TextLabel", None))
        self.database_service_label.setText(QCoreApplication.translate("Form", u"Database", None))
        self.database_version_label.setText(QCoreApplication.translate("Form", u"TextLabel", None))
        self.network_type_label.setText(QCoreApplication.translate("Form", u"TextLabel", None))
        self.webserver_service_label.setText(QCoreApplication.translate("Form", u"Webserver", None))
        self.webserver_type_label.setText(QCoreApplication.translate("Form", u"TextLabel", None))
        self.webserver_version_label.setText(QCoreApplication.translate("Form", u"TextLabel", None))
        self.language_type_label.setText(QCoreApplication.translate("Form", u"TextLabel", None))
    # retranslateUi
